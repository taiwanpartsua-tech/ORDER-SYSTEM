...
export default function Orders() {
  ...
  const statusColors: Record<string, string> = {
    ...
    'в роботі на вчора': 'bg-blue-200 text-blue-900',
    'в роботі на завтра': 'bg-blue-50 text-blue-700',
    'на броні': 'bg-purple-100 text-purple-800',
    'очікується': 'bg-yellow-100 text-yellow-800',
    'очікується посилка': 'bg-yellow-200 text-yellow-900',
    ...
    'на відправці': 'bg-lime-200 text-lime-900',
    'надіслано': 'bg-emerald-100 text-emerald-800',
    ...
    'треба зробити повернення': 'bg-amber-200 text-amber-900',
    'проблемні': 'bg-red-100 text-red-800',
    'зупинено': 'bg-red-200 text-red-900',
    'анульовано': 'bg-gray-100 text-gray-800',
    'скасовано': 'bg-gray-200 text-gray-900',
    'в архиві': 'bg-slate-100 text-slate-800',
    'оформити карткою': 'bg-pink-100 text-pink-800'
  };
  ...
  const statusLabels: Record<string, string> = {
    ...
    'в роботі на вчора': 'В роботі на вчора',
    'в роботі на завтра': 'В роботі на завтра',
    'на броні': 'На броні',
    'очікується': 'Очікується',
    'очікується посилка': 'Очікується посилка',
    ...
    'на відправці': 'На відправці',
    'надіслано': 'Надіслано',
    'в активному прийомі': 'В активному прийомі',
    'на звірці': 'На звірці',
    'повернення': 'Повернення',
    'треба зробити повернення': 'Треба зробити повернення',
    'проблемні': 'Проблемні',
    'зупинено': 'Зупинено',
    'анульовано': 'Анульовано',
    'скасовано': 'Скасовано',
    'в архиві': 'В архиві',
    'оформити карткою': 'Оформити карткою'
  };
